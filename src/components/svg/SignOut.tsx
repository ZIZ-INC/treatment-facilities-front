...
interface SignOutProps {
    fillColor?: string; // Optional prop for color
    width?: number | string; // Optional prop for size (width/height)
    height?: number | string; // Optional prop for size (width/height)
    className?: string; // Optional prop for size (width/height)
}

export const SignOut: React.FC<SignOutProps> = ({
    fillColor = "var(--inactive-color)",
    width,
    height,
    className,
}) => {
